...
const UUID = process.env.UUID || '4edb76f9-13a4-4301-ac29-8eca62afc57b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'coolye007007';            // 获取节点的订阅路径
